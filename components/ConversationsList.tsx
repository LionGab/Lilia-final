...
const ConversationsList: React.FC<ConversationsListProps> = ({ 
  ...
  return (
    <div className="flex flex-col h-screen w-full bg-white dark:bg-black transition-colors">
      {/* Header */}
      <header className="flex-none bg-white dark:bg-black border-b border-slate-100 dark:border-slate-800 px-4 py-3 flex items-center justify-between">
